        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-10 pb-10">
          ...
          <div className="col-span-2 sm:col-span-1 flex flex-col gap-4 text-center sm:text-left">
            ...
            <div className="flex flex-wrap justify-center sm:justify-start gap-3 mt-2">
              ...
              <a href="https://x.com/AdarshVermaBbk" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full border border-gray-500 flex items-center justify-center hover:border-white transition">
                <svg viewBox="0 0 24 24" className="w-4 h-4" fill="white">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231z" />
                </svg>
              </a>

              <a href="https://www.linkedin.com/company/paragon-prime-infotech/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full border border-gray-500 flex items-center justify-center hover:border-[#0A66C2] transition">
                <svg viewBox="0 0 24 24" className="w-4 h-4" fill="white">
              ...
              <a href="https://www.instagram.com/paragonprimeinfo?igsh=dm1rYXFtczdrZmZ6" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full border border-gray-500 flex items-center justify-center hover:border-[#E4405F] transition">
