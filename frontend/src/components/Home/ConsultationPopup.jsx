...
export default function ConsultationPopup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // ── Popup form uses /api/contact/popup ──────────────────
      const endpoint =
        import.meta.env.VITE_CONTACT_ENDPOINT ||
        "http://localhost:5000/api/contact/popup";
              ...
              <div className="mt-6 space-y-2">
                <div className="flex items-center gap-2 text-blue-200 text-sm">
                  <span className="inline-block w-4 h-4">
                    <svg viewBox="0 0 122.88 122.27" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
                ...
                <div className="flex items-center gap-2 text-blue-200 text-sm">
                  <span>
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" viewBox="0 0 122.879 88.855">
                      <g>
              ...
              {submitted ? (
                ...
                <>
                  ...
                  <form onSubmit={handleSubmit} className="flex flex-col gap-3 flex-1">
                    ...
                    >
                      <input type="checkbox" className="w-5 h-5 accent-blue-600" required />
                      <span>I'm not a robot</span>
                      <div className="ml-auto text-right">
                        <div className="w-8 h-8">
                          <svg viewBox="0 0 122.88 116.79" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button
                      ...
                      style={{
                        ...
                        boxShadow: isSending ? "none" : "0 4px 16px rgba(255,100,0,0.3)",
